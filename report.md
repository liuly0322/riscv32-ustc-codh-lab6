...
| ![image-20220517105718522](report/image-20220517105718522.png) | ![image-20220517105718522](report/image-20220517105718522.png) |
| :----------------------------------------------------------: | :----------------------------------------------------------: |
|                     新增 R 型和 I 型指令                     |                         访存指令测试                         |
...
可以在仿真过程中，读 x11和 x10 寄存器，来获取当前进行到了第几个测试样例，以及相应通过情况
